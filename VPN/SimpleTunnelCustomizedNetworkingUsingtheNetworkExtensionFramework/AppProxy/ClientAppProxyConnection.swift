...
class ClientAppProxyConnection : Connection {
	...
	func handleErrorCondition(_ flowError: String? = nil, notifyServer: Bool = true) {
	...
	func closeConnection(_ direction: TunnelConnectionCloseDirection, flowError: String?) {
		super.closeConnection(direction)

		let error =  NSError(domain: NEAppProxyErrorDomain, code: 404, userInfo: nil)
